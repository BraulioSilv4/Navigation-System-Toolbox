...
from common.nmea_data_components import Coordinates, Latitude, Longitude, SatelliteInfo
from common.nmea_enum import NMEAType, StatusIndicator, ModeIndicator
